...
function Login() {
    ...
    const history = useNavigate(); // <-- get history from hook
    ...
    const handleSignInWithGoogle = () => {
        ...
        auth.signInWithPopup(provider)
            .then((result) => {
                ...
                // convert user to interface User
        ...
        <div className="w-full h-screen flex justify-center items-center">
            <form className="mx-auto flex w-full max-w-lg flex-col rounded-xl border border-border bg-backgroundSecondary p-4 sm:p-20">
                <div className="flex w-full flex-col gap-2">
                    <p>Sign in with</p>
                    <div className="flex w-full flex-col gap-2">
                        <button onClick={() => {handleSignInWithGoogle()}} type="button" className="btn gap-2 bg-gray-5">
